...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Usuario creado correctamente', type: user_entity_1.User }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Datos de entrada invu00e1lidos' }),
    (0, swagger_1.ApiResponse)({ status: 409, description: 'El correo ya existe' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Usuario actualizado correctamente', type: user_entity_1.User }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Datos de entrada invu00e1lidos' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Usuario no encontrado' }),
    __param(0, (0, common_1.Param)('id')),
